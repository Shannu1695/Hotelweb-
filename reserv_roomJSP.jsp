<%-- 
    ...
    Created on : 02-Sept-2023, 1:34:56 am
    Author     : Sri Sai
--%>
    ...
    <%
        ...
        try {
            ...
            int i = stmt.executeUpdate(
                "INSERT INTO room_reservations (name, phone, email, guests, room_type, rooms, check_in, check_out) VALUES " +
                "('" + name + "', '" + phone + "', '" + email + "', " + guests + ", '" + roomType + "', " + rooms + ", '" + checkIn + "', '" + checkOut + "')"
            );
